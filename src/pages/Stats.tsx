...
import { overallAccuracy, topicAccuracy, currentStreak, cardsMastered, weakestSubtopics } from '../lib/stats'
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-2">
            {weakest.map((row) => (
              <div
                key={row.subtopic}
                className="flex items-center justify-between rounded-xl bg-neutral-900/[0.03] dark:bg-white/[0.04] px-4 py-3"
              >
